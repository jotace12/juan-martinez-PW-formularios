...
import { IStocks } from 'src/app/Interface/stock';
interface IUser {
  name: string;
  state: string;
  registered: string;
...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    private productosServicio: ProductosService ,private proveedorServicio: ProveedoresService ,private stockServicio: StocksService
  ) {}
